...
urlpatterns = [
    ...
    path('deconexion/', views.deconnexion, name='deconnexion'),
    ...
    path('affecter_prof/<int:responsable_id>/', views.affecter_professeur, name='affecter_professeur'),
    ...
    path('classes/<int:classe_id>/', views.classes, name='classes'),
    path('pointage/<int:teacher_id>/', views.pointage_view, name='pointage_view'),
    path('confirmation_pointage/', views.confirmation_pointage, name='confirmation_pointage'),
