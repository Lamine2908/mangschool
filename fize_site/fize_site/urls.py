...
urlpatterns = [
    ...
    path('filter_students/<int:admin_id>/', views.filter_students, name='filter_students'),
    path('filter_teachers_view/<int:admin_id>/', views.filter_teachers, name='filter_teachers'),
    ...
    path('liste_filieres/<int:admin_id>/', views.liste_filieres, name='liste_filieres'),
    ...
    path('student/update/<int:admin_id>/<int:student_id>/', views.update_student, name='update_student'),
    path('modifier_responsable/<int:admin_id>/<int:responsable_id>/', views.update_responsable, name='update_responsable'),
    path('suprof/<int:admin_id>/<int:teacher_id>/', views.delete_teacher_by_id, name='delete_teacher_by_id'),
    ...
    path('liste_classe/<int:admin_id>/', views.liste_classe, name='liste_classe'),
    ...
    path('ajouter_classe/<int:admin_id>/', views.ajouter_classe, name='ajouter_classe'),
    ...
    path('modifier_responsable_metier/<int:admin_id>/<int:respons_met_id>/', views.modifier_respons_metier, name="modifier_respons_metier"),
    path('mot_de_passe/<int:student_id>/', views.mot_de_passe, name="mot_de_passe"),
