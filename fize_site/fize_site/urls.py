...
urlpatterns = [
    ...
    path('teacher/<int:teacher_id>/students/', views.prof_etudiant_list, name='prof_etudiant_list'),
    path('ajouter_note/<int:teacher_id>/students/', views.ajouter_notes, name='ajouter_notes'),
    path('afficher_notes/<int:teacher_id>/students/', views.afficher_notes, name='afficher_notes'),
